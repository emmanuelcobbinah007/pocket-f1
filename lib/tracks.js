...
/** @type {TrackDefinition} */
export const SUMMIT_SWITCH = {
  id: "summit-switch",
  name: "Summit Switch",
  tagline: "Alpine hairpins · cliffside esses · mountain tunnel",
  viewBox: { width: 1615, height: 974 },
  backgroundUrl: "/tracks/summit_switch.webp",
  drsZone: { start: 0.0, end: 0.06 },
  pitEntry: 0.01,
  available: true,
  waypoints: [
...
/** @type {TrackDefinition[]} */
export const TRACKS = [POCKET_RING, HARBOR_LOOP, SUMMIT_SWITCH];
