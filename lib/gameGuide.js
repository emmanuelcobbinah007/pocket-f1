...
export const HOW_TO_PLAY = [
  {
    title: "Pick & ready up",
    body: "4–8 drivers pick a unique racer, then tap READY on each slot (or use Ready All). Fill empty slots with AI if you're short on friends.",
  },
  {
  ...
  {
    title: "Race & pit",
    body: `Short sprint around the chosen circuit. Tyres wear each lap — past 75% wear you hit a pace cliff. Hit Box Box to pit for fresh rubber (costs track position). Pit limits scale with distance: 1 stop on 3-lap races, up to 2 on longer sprints. Default races are ${DEFAULT_LAPS} laps; change distance in the lobby.`,
  },
  {
    title: "DRS overtake mini-game",
    body: "Close behind a car on the start straight? A timing prompt appears — hit it cleanly to complete the pass. Joker and Blaze get wider windows; Brick shrinks the window for anyone trying to pass him.",
  },
  {
...
export const F1_BASICS = [
  ...
  {
    title: "Pit stops",
    body: "Boxing loses time on track but resets tyre wear. AI rivals pit too — some gamble under Safety Car. Pit limits: 1 stop (3 laps), 2 stops (5–10 laps).",
  },
  {
    title: "DRS",
  ...
  {
    title: "Safety Car",
    body: "Deployed after incidents to slow the field. Everyone bunches up — gaps disappear and late-race chaos follows. AI may box during SC for fresh tyres, but not every car every time.",
  },
  {
    title: "Perks & jerks",
