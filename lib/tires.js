...
export const TIRES = {
  hard: {
    ...
    iconUrl: "/sprites/icons/tire-hard.webp",
  },
  medium: {
    label: "Medium",
    speedMultiplier: 1.0,
    degradationPerLap: 0.02,
    iconUrl: "/sprites/icons/tire-medium.webp",
  },
  soft: {
    label: "Soft",
    speedMultiplier: 1.08,
    degradationPerLap: 0.04,
    iconUrl: "/sprites/icons/tire-soft.webp",
  },
};

export const WEAR_CLIFF_THRESHOLD = 0.75;
export const WEAR_CLIFF_PENALTY = 0.35;
/** Global tyre wear multiplier — tuned for 10-lap races needing pits. */
export const WEAR_RATE_MULTIPLIER = 4;
